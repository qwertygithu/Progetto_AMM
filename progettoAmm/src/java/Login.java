    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       //Apertura della sessione
        ...
        //Se l'utente non è loggato...
            ...
            String username = request.getParameter("nomeLogin");
            ...
            */
            if (username != null && password != null) 
            {
                ...
                if(loggedUserID != -1)
                {
                    ...
                    //controllo che i dati nel form sia tutti inseriti
                    if(utente.getNome()==null || utente.getNome().isEmpty()
                       ||utente.getCognome()==null || utente.getCognome().isEmpty()
                       ||utente.getUrlFotoProfilo()==null || utente.getUrlFotoProfilo().isEmpty()
                       ||utente.getFrase()==null || utente.getFrase().isEmpty()){
